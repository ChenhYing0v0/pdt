...
DATA_SUBDIR=exchange_rate
MATRIX_KEY=exchange_rate
ENC_IN=8
TARGET=OT
FREQ=h
LADJ=type1
PL_LIST=(96 192 336 720)
LEARNING_RATE_LIST=(0.0001 0.0001 0.0001 0.0001)
D_MODEL_LIST=(256 128 256 256)
D_FF_LIST=(256 128 256 256)
E_LAYER_LIST=(2 2 2 2)
BATCH_SIZE_LIST=(16 16 16 16)
DROPOUT_LIST=(0.0 0.0 0.0 0.0)
R_RANK_LIST=(96 96 96 96)
K_TOP_LIST=(64 16 32 96)
ALPHA_INIT_LIST=(0.5 0.05 0.5 0.05)
MASK_THRESHOLD_LIST=(0.05 0.05 0.05 0.15)
