...
def prepare_output_paths(args):
    output_dir = args.output_dir or os.path.join('.', 'outputs', args.run_id or args.model_id)
    args.output_dir = os.path.abspath(output_dir)
    args.checkpoints = os.path.join(args.output_dir, 'checkpoints')
    args.test_results_dir = os.path.join(args.output_dir, 'test_results')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--selection_policy', type=str, default='best_val_mse', help='protocol checkpoint selection policy')
    parser.add_argument('--skip_predictions', action='store_true', help='skip prediction artifact export')
    ...
    if args.use_gpu and args.use_multi_gpu:
        ...
        args.device_ids = [int(device) for device in device_ids]
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            if args.do_predict and not args.skip_predictions:
