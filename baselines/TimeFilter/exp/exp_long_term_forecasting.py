...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def test(self, setting, test=0):
        ...
        if output_dir:
            ...
            result_log_path = os.path.join(output_dir, 'result_long_term_forecast.txt')
        else:
            result_log_path = "result_long_term_forecast.txt"
        ...
        if output_dir:
            ...
            if os.path.exists(checkpoint_path):
                shutil.copy2(checkpoint_path, os.path.join(output_dir, 'best.ckpt'))
