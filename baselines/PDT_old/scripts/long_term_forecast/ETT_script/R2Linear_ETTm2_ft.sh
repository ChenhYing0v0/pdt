...
alpha_search_space=(0.05 0.2 0.35 0.5 0.7)
mask_thr_search_space=(0.01 0.05 0.15 0.3 0.5)
...
learning_rate_list=(1e-4 1e-4)
# dropout_list=(0.2 0.2 0.2 0.3)
    ...
    for k_top in "${k_top_search_space[@]}"; do
        ...
        for alpha in "${alpha_search_space[@]}"; do
            ...
            python -u run_IN.py \
                ...
                --data_path ETTm2.csv \
                --q_mat_file ./dataset/RRR_mats/ETTm2/ETTm2_RRR_L96_R${r_rank}_H${pl}_Qin.npy \
                --q_out_mat_file ./dataset/PCCA_mats/ETTm2/ETTm2_PCCA_OUT_H${pl}_identity_avg.npy \
                --r_mat_file ./dataset/RRR_mats/ETTm2/ETTm2_RRR_L96_R${r_rank}_H${pl}_R.npy \
                --rk_mat_file ./dataset/RRR_mats/ETTm2/ETTm2_RRR_L96_R${k_top}_H${pl}_R.npy \
                --Q_chan_indep 0 \
