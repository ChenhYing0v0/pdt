...
for ((i=0; i<$num_exp; i++)); do
    ...
    CUDA_VISIBLE_DEVICES=0 python -u run_IN.py \
        ...
        --q_mat_file ./dataset/cov_mats/traffic/traffic_96_ratio0.7.npy \
        --q_out_mat_file ./dataset/PCCA_mats/traffic/traffic_PCCA_OUT_H${pl}_avg.npy \
        --Q_chan_indep 0 \
...
echo "All finished ..."
        ...
        # --q_out_mat_file ./dataset/cov_mats/traffic/traffic_${pl}_ratio0.7.npy \