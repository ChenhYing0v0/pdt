...
for ((i=0; i<$num_exp; i++)); do
    ...
    CUDA_VISIBLE_DEVICES=1 python -u run_IN.py \
        ...
        --q_mat_file ./dataset/PCCA_mats/electricity/electricity_PCCA_L96_K${k_dim}_H${pl}_avg_new.npy \
        --q_out_mat_file ./dataset/PCCA_mats/electricity/electricity_PCCA_OUT_L96_K${k_dim}_H${pl}_svdB_avg_new.npy \
        --Q_MAT_file ./dataset/PCCA_mats/electricity/electricity_PCCA_L96_K${k_dim}_H${pl}_perchan.npy \
        --Q_OUT_MAT_file ./dataset/PCCA_mats/electricity/electricity_PCCA_OUT_H${pl}_perchan.npy \
        --Q_chan_indep 0 \
