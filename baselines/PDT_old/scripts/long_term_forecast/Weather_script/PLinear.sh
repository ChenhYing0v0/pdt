...
for ((i=0; i<$num_exp; i++)); do
    ...
    CUDA_VISIBLE_DEVICES=0 python -u run_IN.py \
        ...
        --q_mat_file ./dataset/PCCA_mats/weather/weather_PCCA_L96_K${k_dim}_H${pl}_avg.npy \
        --q_out_mat_file ./dataset/PCCA_mats/weather/weather_PCCA_OUT_L96_K${k_dim}_H${pl}_svdB_avg.npy \
        --Q_MAT_file ./dataset/PCCA_mats/weather/weather_PCCA_L96_K${k_dim}_H${pl}_perchan.npy \
        --Q_OUT_MAT_file ./dataset/PCCA_mats/weather/weather_PCCA_OUT_H${pl}_perchan.npy \
        --Q_chan_indep 0 \
