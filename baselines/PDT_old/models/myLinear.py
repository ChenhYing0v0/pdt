...
class Model(nn.Module):
    ...
    def __init__(self, configs, individual=False):
        ...
        if self.individual:
            ...
            self.Linear.weight = nn.Parameter(scale * torch.ones([self.pred_len, self.seq_len]))
    ...
    def encoder(self, x):
        ...
        if self.individual:
            ...
            if self.iter_norm:
                init = self.iter_norm(init.permute(0, 2, 1)).permute(0, 2, 1)     # input shape: [B, L, D]
