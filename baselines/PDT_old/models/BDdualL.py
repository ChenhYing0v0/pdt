...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        if configs.iter_norm:
            self.iter_norm = IterNormSequential(self.channels, num_groups=configs.num_groups, T=configs.T, eps=configs.eps, momentum=configs.momentum, affine=configs.affine)
        else:
            self.iter_norm = None
